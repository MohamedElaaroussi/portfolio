...
import { cities, nationalities, roles, status, types } from "@/utils/data";
            ...
            <div className="flex flex-col gap-[3vh]">
              <div className="flex flex-col items-center p-[8vw] lg:p-[2vw] bg-WT rounded-lg gap-[1.5vh] justify-center shadow-lg ">
                <label htmlFor="file" >
                  ...
                  /> */}
                    <div className="rounded-lg flex bg-text w-[80vw] h-[30vh] lg:w-[17vw] lg:h-[14vw] items-center justify-center"><span className="text-WT font-medium text-[25vw] lg:text-[6vw]">A</span></div>
            ...
            <div className="flex flex-col gap-[2.5vh]">
              <div className="w-[90vw] lg:w-[50vw] flex bg-WT py-[3vh] lg:px-[2vw] px-[4vw] flex-col gap-[4vh] rounded-lg shadow-sm">
                ...
                <div className='flex justify-start gap-[4vw] lg:gap-[2vw] items-center'>
                  ...
                  <Button className='bg-text lg:w-[10vw] lg:h-[2.5vw] rounded-md mt-[1.8vh]' >
                ...
                <div className="flex justify-between">
                  <div className="flex flex-col gap-[3vh]">
                    ...
                    <Input
                      ...
                      classNames={{
                        base: " rounded-full ",
                        inputWrapper: "h-[4vh] lg:h-[4vw] bg-search flex text-sub-title rounded-lg border-none hover:!bg-search pr-6",
                        // label: "text-[0.8vw] text-default-500 font-medium px-3 ",
                        input: "rounded-none text-darck bg-search px-3 lg:text-[0.8vw] font-medium"
                      }}
                      labelPlacement="outside"
              ...
              <div className="flex justify-end gap-[1.2vw]">
                ...
                <Link href={'/users'}>
                  <Button className="bg-green rounded-md py-2 w-[15vw]" type="submit" href={'/users'}>
